...
1. STRICT WORKSPACE BOUNDARY: You are ONLY allowed to read, create, edit, or delete files strictly within the current working directory (`D:\UIT\NamBonUIT\CareBridge`).
